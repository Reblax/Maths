...
\begin{proof}
    ...
    \begin{center}
        \begin{tikzcd}
            & & & \coker f \\
            0 \arrow[r] & X \arrow[r,"f"] \arrow[d] & Y \arrow[ru,"\pi_f"] \arrow[r,"g"] & Z \\
            & \coim f \arrow[r,"\sim"] & \im f \arrow[u] \arrow[r] & \ker g \arrow[lu,"i_g"]
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            ...
            \ker g \arrow[u,"\phi^{-1}"] \arrow[ru,"i_g" description] & T \arrow[u,"h" '] \arrow[l,dashed,"\overline{h}"]
        \end{tikzcd}
    \end{center}
    So $\phi^{-1} \overline{h}$ is a factorization of $h$ through $f$. If we have another factorization $\psi$ then
    \begin{center}
        \begin{tikzcd}
            \ker g \arrow[r,"i_g"] & Y \arrow[r] & Z \\
            X \arrow[u,"\phi"] \arrow[ru,"f" description] & T \arrow[l,"\psi"] \arrow[u, "h"']
        \end{tikzcd}
    \end{center}
...
\begin{center}
    \begin{tikzcd}
        \im d_n^X
            \arrow[r, "i"]
            \arrow[d,"B(f_n)", dashed]
        & X_{n-1}
            \arrow[r,"\pi"]
            \arrow[d,"f_{n-1}"]
        & \coker (d_n^X)
            \arrow[d,"\overline{f_{n-1}}"]
        \\ \im d_n^Y
            \arrow[r,"i" ']
        & Y_{n-1}
            \arrow[r,"\pi" ']
...
\begin{center}
    \begin{tikzcd}
        \im d_{n+1}^X
            \arrow[r,hookrightarrow,"i"]
            \arrow[d, "B_n(f)"]
        & \ker d_n
            \arrow[r]
            \arrow[d,"Z_n(f)"]
        & \coker i
            \arrow[d,"H_n(f)",dashed]
        \\ \im d_{n+1}^Y
...
\begin{remark}
    ...
    \begin{center}
        \begin{tikzcd}
            0 \arrow[r]
            &
            A \arrow[r,"\alpha"] \arrow[d,"f" ']
            &
            B \arrow[r,"\beta"] \arrow[d,"g" ']
            &
            C \arrow[r] \arrow[d,"h"]
            &
            0
    ...
    \begin{center}
        \begin{tikzcd}
            \cdots \arrow[r]
            &
            H_n(A) \arrow[r,"H_n(\alpha)"] \arrow[d,"H_n(f)" ']
            &
            H_n(B) \arrow[r,"H_n(\beta)"] \arrow[d,"H_n(g)" ']
            &
            H_n(C) \arrow[r,"\delta_n"] \arrow[d,"H_n(h)" ']
            &
            H_{n-1}(A) \arrow[r,"H_{n-1}(\alpha)"] \arrow[d,"H_{n-1}(f)"]
            &
            H_{n-1}(B) \arrow[r] \arrow[d,"H_{n-1}(g)"]
            &
            \cdots
            \\
            \cdots \arrow[r]
            &
            H_n(A') \arrow[r,"H_n(\alpha')" ']
            &
            H_n(B') \arrow[r,"H_n(\beta')" ']
            &
            H_n(C') \arrow[r,"\delta_n '" ']
            &
            H_{n-1}(A') \arrow[r,"H_{n-1}(\alpha')" ']
            &
            H_{n-1}(B') \arrow[r]
            &
            \cdots
...
\begin{definition}
    Let $\Acat$ be an abelian category. A \emph{pullback} of $\alpha : A \to C$ and $\beta : B \to C$ is a limit of the diagram \begin{tikzcd}[row sep=small, column sep=small]
        & B \arrow[d,"\beta"] \\ A \arrow[r,"\alpha" '] & C
    \end{tikzcd}
    . Diagramatically, the pullback is the object $P$ together with the two morphisms $p_1,p_2$:
    \begin{center}
        \begin{tikzcd}
            Q \arrow[ddr,"q_1" ',bend right] \arrow[rrd,"q_2",bend left] \arrow[rd,"\exists !",dashed] \\
            & P \arrow[d,"p_1"] \arrow[r,"p_2"] & B \arrow[d,"\beta"] \\
            & A \arrow[r,"\alpha" '] & C
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            A \arrow[d,"\beta" '] \arrow[r,"\alpha"] & B \arrow[d] \arrow[ddr,bend left] \\
            C \arrow[r] \arrow[rrd,bend right] & P \arrow[dr,"\exists !", dashed] \\
            & & Q
        \end{tikzcd}
    \end{center}
\end{definition}
...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \begin{center}
            \begin{tikzcd}
                \ker p_2 \arrow[r] \arrow[d,dashed,"\simeq"] & P \arrow[r,"p_2"] \arrow[d,"p_1"] & Y \arrow[d,"g"] \\
                \ker f \arrow[r] & X \arrow[r,"f"] & Z
            \end{tikzcd}
        \end{center}
...
\begin{proof}
    1. is clear since pullback and pushouts are small (co)limits. Let's prove 2. We use the same notations as in the definition above. Assume $\alpha$ is a monomorphism. Consider a pair of parallel morphisms \begin{tikzcd}
        W \arrow[r,shift left,"a"] \arrow[r,shift right,"b" '] & P
    \end{tikzcd}
    such that $p_2 a = p_2 b$. Then we have a diagram
    \begin{center}
        \begin{tikzcd}
            W \arrow[rd,shift left, "b"] \arrow[rd,shift right, "a" '] \arrow[rdd,"p_1 a" ', bend right] \arrow[rrd,"p_2 b", bend left] \\
            & P \arrow[d,"p_1"] \arrow[r,"p_2"] & B \arrow[d,"\beta"] \\
            & A \arrow[r,"\alpha" '] & C
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            \ker p_2 \arrow[r,"i_2"] \arrow[d,dashed,"\exists ! p"] & P \arrow[r,"p_2"] \arrow[d,"p_1"] & Y \arrow[d,"g"] \\
            \ker f \arrow[r,"i_1"] & X \arrow[r,"f"] & Z
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            & \ker f \arrow[ddr,"i_1" ',bend right] \arrow[rrd,"0",bend left] \arrow[rd,"\exists ! t",dashed] \arrow[ld,"\exists ! q" ',dashed] \\
            \ker p_2 \arrow[rr] & & P \arrow[d,"p_1"] \arrow[r,"p_2"] & Y \arrow[d,"g"] \\
            & & X \arrow[r,"f" '] & Z
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            \ker f \arrow[r,"i_1"] & X \arrow[r,"f"] & Z \\
            \ker p_2 \arrow[u,"p"] & \ker f \arrow[l,"q"] \arrow[u,"i_1" ']
        \end{tikzcd}
    \end{center}
    ...
    \begin{center}
        \begin{tikzcd}
            \ker p_2 \arrow[rd,"i_2 qp"] \arrow[rrd,"0", bend left] \arrow[ddr,"p_1 i_2" ', bend right] \\
