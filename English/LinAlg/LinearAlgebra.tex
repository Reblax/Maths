...
%composée de morphismes est un morphisme
%isomorphismes
%idée de transport de propriétés : groupe iso à un grp ab est ab
%exemple : petits groupes (à iso près) (utilité des isos) (c'est bien les isos)
%exemple ou exo : conjugaison
%groupe des automorphismes
%exo : aut(petit groupe)
%automorphismes intérieurs
%show that a group is cyclic iff there exists Z -> G surjective
%noyau, image, "fonctorialité" au sens de françois charles mdr
...
% construire C avec R[X]/(X^2 + 1) (en remarque)
...
%Nombres algébriques forment un corps
%MQ unique corps corps fini de chaque cardinal à iso près et etudier deux trois trucs maybe
