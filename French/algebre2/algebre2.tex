...
\begin{proof}
    ...
    % TODO demander de check parce que j'ai bricolé moi même mais c'est convaincant non ?
\end{proof}
...
\begin{definition}
    ...
    \begin{tikzcd}[row sep=small, column sep=small]
        & Z & \\
        X \arrow[rr,"f" '] \arrow[ru,"g \circ f" sloped] & & Y \arrow[lu,"g" sloped]
    \end{tikzcd}
    dans $\cat$ devient
    \begin{tikzcd}[row sep=small, column sep=small]
        & Z \arrow[ld,"f \circ g" sloped,pos=0.4] \arrow[rd,"g" sloped] & \\
        X & & Y \arrow[ll,"f"]
    \end{tikzcd}
    dans $\cat^\op$.
\end{definition}
...
\begin{center}
    \begin{tikzcd}
        F(X) \arrow[r,"\eta_X"] \arrow[d,"F(f)"] & G(X) \arrow[r,"\phi_X"] \arrow[d,"G(f)"] & H(X) \arrow[d,"H(f)"] \\
        F(Y) \arrow[r,"\eta_Y"] & G(Y) \arrow[r,"\phi_Y"] & H(Y)
    \end{tikzcd}
\end{center}
...
\begin{center}
    \begin{tikzcd}
        & X \arrow[ld,"f" '] \arrow[d,"h"] \arrow[rd,"g"] & \\
